...
namespace AgriculturePresentation.Controllers
{
    public class ReportController : Controller
    {
        ...
        public IActionResult StaticReport()
        {
            ...
            workBook.Cells[3, 3].Value = "1.986";
            ...
            return File(bytes, "application/vdn.openxmlformats-officedocument.spreadsheethtml.sheet", "BakliyatRaporu.xlsx");
        ...
        public IActionResult ContactReport()
        {
            using(var workBook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    return File(content, "application/vdn.openxmlformats-officedocument.spreadsheethtml.sheet", "MesajRaporu.xlsx");
                }
        ...
        public IActionResult AnnouncementReport()
        {
            using (var workBook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    workBook.SaveAs(stream);
                    var content = stream.ToArray();
                    return File(content, "application/vdn.openxmlformats-officedocument.spreadsheethtml.sheet", "DuyuruRaporu.xlsx");
                }
